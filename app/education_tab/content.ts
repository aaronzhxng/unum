    ...
    subtopics: [
      {
        ...
        summary:
          "The founding document that defines how the U.S. government works and the rights of every American.",
        body: [
          {
            type: "text",
          ...
          {
            type: "image",
            source: null, // TODO: add require("../../../assets/education_content/constitution_document.png")
            caption:
          ...
          },
          {
            ...
            content:
              "The Constitution was purposely made very difficult to change, or amend, so that its basic structure would always stay the same. The only way amendments have been passed is:\n\n• At least two-thirds of Congress voted for it, and then\n• The governments or the citizens in at least three-fourths of the states also voted for it.\n\nIt is also possible for there to be a Constitutional Convention for proposing amendments, which happens if two-thirds of states ask for one — though this has never occurred.",
          },
          {
            type: "text",
            heading: "History",
          ...
          },
          {
            ...
            content:
              "A state cannot pass a law that goes against what the Constitution says. In the past, the national government has overridden state laws several times by amending the Constitution — to abolish slavery, to allow women and young people to vote, and to introduce a national income tax.\n\nHowever, the 10th Amendment guarantees that all rights not given to the national government belong to the states or to the people. Therefore, the federal government is also a limited government.",
          },
          {
            type: "text",
            heading: "The Supreme Court's Role",
            content:
              'The Constitution is one of the shortest and oldest in the world. Because of this, a lot of the language can seem vague or outdated. A large part of the Supreme Court\'s job is determining whether a law or an executive action is "constitutional," and therefore can be carried out. If a majority of the Supreme Court rules that it is not constitutional, then the law is invalid.\n\nThe Supreme Court also determines how far civil and legal rights practically extend. For example, in 1963, the Supreme Court ruled that part of due process included the right to have a lawyer, so anyone who is too poor to pay for one can be assigned one by the government.',
          },
          {
            type: "text",
            heading: "Why It Matters",
            content:
              "Knowing the U.S. Constitution is important for two main reasons.\n\nFirstly, it means that you know in a broad way how the federal government is set up and what principles the United States holds dear: federalism, limited government, and democratic republicanism.\n\nSecondly, it helps you know what the government must do, what it may do, and what it absolutely cannot do. This way, you can take advantage of all the freedoms that exist in this country. It also means you understand what areas are the responsibility of the federal government, and what is the responsibility of the state government.",
          },
          {
            type: "text",
            heading: "Learn More",
            content:
              "See the full text of the Constitution and all its amendments:\nconstitutioncenter.org/the-constitution\n\nLearn how the Supreme Court has interpreted the Constitution throughout history:\nconstitution.congress.gov\n\nLearn about important rights that all Americans have:\njustice.gov (search \"Know Your Rights\")",
          },
        ],
      },
      {
